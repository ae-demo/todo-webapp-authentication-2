...
export type OperationKey =
  | "DELETE /me/todos/{todoId}"
  | "GET /me/todos"
  | "PATCH /me/todos/{todoId}"
  | "POST /me/todos";

export const OPERATIONS: Record<OperationKey, OperationRequirement> = {
  "DELETE /me/todos/{todoId}": { kind: "scope", scope: "todos:submit" },
  "GET /me/todos": { kind: "scope", scope: "todos:read" },
  "PATCH /me/todos/{todoId}": { kind: "scope", scope: "todos:submit" },
  "POST /me/todos": { kind: "scope", scope: "todos:submit" },
};
