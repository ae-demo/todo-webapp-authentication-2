...
// NOTE: this app installs only `react-router` (v7 unifies what v6 split into
// react-router/react-router-dom); v7's package exports the DOM bindings
// directly, so this is the one import edited from the asset's verbatim
// `react-router-dom` to avoid a second, differently-versioned router package.
